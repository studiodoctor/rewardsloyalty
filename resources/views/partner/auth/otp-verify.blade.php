        ...
        <div
            ...
            <div class="w-full max-w-[440px] space-y-8 animate-fade-in-up">
                ...
                <div class="text-center space-y-3">
                    {{-- Email Icon --}}
                    <div class="mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br from-primary-500/10 to-primary-500/10 dark:from-primary-500/20 dark:to-primary-500/20 flex items-center justify-center mb-4">
                ...
                {{-- OTP Form --}}
                <x-forms.form-open id="otp-form" class="space-y-6" :action="route('partner.login.otp.verify.post')" method="POST" />
                    ...
                    <div class="pt-4 text-center">
                        <a href="{{ route('partner.login') }}" class="text-sm font-medium text-secondary-500 hover:text-secondary-700 dark:text-secondary-400 dark:hover:text-secondary-200 transition-colors">
...
document.addEventListener('alpine:init', () => {
    Alpine.data('resendCooldown', (config = {}) => ({
        ...
        async resend() {
            ...
            try {
                const response = await fetch('{{ route('partner.login.otp.resend') }}', {
                    method: 'POST',
                    headers: {
