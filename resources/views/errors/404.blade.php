...
<section class="mx-auto">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <p class="mb-4 text-3xl tracking-tight font-bold text-secondary-900 md:text-4xl dark:text-white">{{ trans('common.404_title') }}</p>
            <p class="mb-4 text-lg font-light text-secondary-500 dark:text-secondary-400">{!! trans('common.404_description') !!}</p>
