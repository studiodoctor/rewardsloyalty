...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The Resend API key gives you access to Resend's API. The "api_key" is
    | typically used to make email requests to the API.
    |
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Your Resend webhook secret is used to prevent unauthorized requests to
