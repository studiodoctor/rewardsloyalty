...
class StampController extends Controller
{
     ...
     *
     * GET /{locale}/admin/stamp-transactions/{member_identifier}/{stamp_card_id}
     */
    public function showStampTransactions(string $locale, string $member_identifier, string $stamp_card_id)
    {
        ...
        return view('admin.stamps.history', compact('member', 'card', 'enrollment'));
    }

    /**
     * Delete the last stamp transaction.
     *
     * GET /{locale}/admin/delete-last-stamp/{member_identifier}/{stamp_card_id}
     */
    public function deleteLastStamp(string $locale, string $member_identifier, string $stamp_card_id)
    {
        ...
        return redirect()->route('admin.stamp.transactions', [
