 ...
 *
 * Purpose:
 * Represents an Admin user (Super Admin or Manager) in the application.
 * Admins have platform-wide access and manage networks, partners, and system settings.
 */
...
{
    use HasApiTokens, HasFactory, HasSchemaAccessors, HasUuids, InteractsWithMedia, LogsModelActivity, Notifiable;
